...
It supports Controller and more customizable Screen Keys. For Controller input make sure to enable "Prefer scancodes when possible" and disable "Hardware keyboard scancodes workaround".
