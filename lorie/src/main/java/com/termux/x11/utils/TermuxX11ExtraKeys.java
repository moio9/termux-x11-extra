...
public class TermuxX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME','UP',{key: 'END', popup: 'ZOOM_IN'},{key: 'PGUP', popup: 'ZOOM_OUT'},{key: 'PREFERENCES', popup: 'ZOOM_RESET'},'MAPPER'], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN','KEYBOARD','EXIT']]"; // Double row
